...
This snippet shows how to configure Agent-S2 to use remote vLLM
endpoints: one hosting Qwen3-32B for language generation and another
running UI-TARS-1.5-7B for visual grounding. Replace the dummy URLs
...
engine_params = {
    "engine_type": "vllm",
    "model": "Qwen3-32B",
    "base_url": "http://localhost:8002/v1",  # Dummy Qwen vLLM endpoint
}

# ---------------------------------------------------------------------------
# Configuration of the grounding model (UI-TARS-1.5-7B) served by a remote vLLM instance
# ---------------------------------------------------------------------------
...
engine_params_for_grounding = {
    ...
    "base_url": "http://localhost:8001/v1",  # Dummy UI-TARS vLLM endpoint
