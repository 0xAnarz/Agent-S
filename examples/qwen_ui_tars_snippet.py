...
This snippet shows how to configure Agent-S2 to use a remote vLLM
endpoint hosting Qwen3-32B for language generation, while relying on
UI-TARS-1.5-7B to ground visual references. Replace the dummy URLs and
API keys with your own endpoints.
...
engine_params = {
    "engine_type": "vllm",
    "model": "Qwen3-32B",
    "base_url": "http://localhost:8000/v1",  # Dummy vLLM endpoint
}

# ---------------------------------------------------------------------------
# Configuration of the grounding model (UI-TARS-1.5-7B) hosted on a HF endpoint
# ---------------------------------------------------------------------------
...
engine_params_for_grounding = {
    "engine_type": "huggingface",  # Using a HuggingFace TGI server
    "model": "UI-TARS-1.5-7B",
    "base_url": "http://localhost:8080",  # Dummy UI-TARS endpoint
